...
(async () => {
  ...
  assert.equal(
    Object.prototype.hasOwnProperty.call(snapshot.currentState, 'reusablePhoneActivation'),
    false,
    'reusable phone activation should be removed from fresh-attempt reset state'
  );
