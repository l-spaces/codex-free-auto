...
return {
  ...
  assert.equal(api.normalizePersistentSettingValue('cloudflareTempEmailFixedMailbox', ' Fixed@Example.com '), 'fixed@example.com');
  ...
  assert.equal(payload.cloudflareTempEmailFixedMailbox, 'fixed@example.com');
  ...
  assert.deepEqual(config, {
    ...
    fixedMailbox: 'fixed@example.com',
